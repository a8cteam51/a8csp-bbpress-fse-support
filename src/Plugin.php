...
class Plugin {
	...
	public function is_active(): bool|\WP_Error {
		...
		$minimum_wc_version = a8csp_bbpress_fse_support_get_plugin_metadata( \WC_Plugin_Updates::VERSION_REQUIRED_HEADER );
	...
	public function maybe_initialize(): void {
		...
		if ( is_wp_error( $is_active ) ) {
			a8csp_bbpress_fse_support_output_requirements_error( $is_active );
			return;
		}
